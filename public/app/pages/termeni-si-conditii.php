...
<section class="section">
  <div class="container">
    <div style="max-width: 820px; margin: 0 auto;">
      ...
      <h2 style="margin-top:32px;">Conținut și drepturi de autor</h2>
      ...
      <h2 style="margin-top:32px;">Modificarea termenilor și condițiilor de utilizare</h2>
      ...
      <h2 style="margin-top:32px;">Cereri de ofertă</h2>
      ...
      <h2 style="margin-top:32px;">Termeni de utilizare a site-ului</h2>
      ...
      <h2 style="margin-top:32px;">Informații oferite prin acest website</h2>
      ...
      <h2 style="margin-top:32px;">Materiale transmise către acest site</h2>
